  ...
  return (
    <>
      <div className="max-w-[1000px] w-full mb-8">
        ...
        <img
          className="w-full"
          src="../../src/assets/letters/hebrewAlphabet.png"
          alt="Hebrew alphabet"
        />
      </div>
      <div className="max-w-[400px] w-full mb-8">
        ...
        <img
          className="w-full"
          src="../../src/assets/letters/hebrewFinalLetters.png"
          alt="Hebrew final letters"
        />
      </div>
      <div className="max-w-[600px] w-full mb-8">
        ...
        <img
          className="w-full"
          src="../../src/assets/letters/hebrewNiqqud.jpg"
          alt="Hebrew niqqud"
        />
      </div>
      <div className="max-w-[1000px] w-full mb-8">
        ...
        <img
          className="w-full"
          src="../../src/assets/letters/hebrewKeyboardLayout.jpg"
