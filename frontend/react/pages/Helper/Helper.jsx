...
export default function Helper() {
    ...
    return ( 
        <main className="px-(--page-px) mt-4 flex flex-col items-end">
            ...
            <form action="get" onSubmit={(e) => {
                ...
                <input className="w-[300px] h-[50px] border-2 border-(--primary) indent-1" value={input} type="text" name="word" placeholder="Type your word" onChange={(e) => setInput(e.target.value)}/>
                <input className="
                w-[100px] h-[50px] ml-1 border-2 border-(--primary) 
                transition-colors cursor-pointer hover:bg-(--primary)
                hover:text-white 
                " type="submit" value="Help"/>
            </form>
